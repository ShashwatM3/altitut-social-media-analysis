/**
 * Default description of Altitut used to seed the Competitor Scout input
 * dialog. Carried over from the archived build's DEFAULT_ALTITUT_CONTEXT and
 * enriched with the product overview in docs/ALTITUT-PRODUCT-OVERVIEW.md.
 */
export const DEFAULT_ALTITUT_DESCRIPTION =
...
/**
 * Condensed Altitut knowledge injected into the competitor-analysis chatbot's
 * system prompt so it can connect competitor insights back to our product.
 */
export const ALTITUT_CHAT_CONTEXT = `Altitut is an entrepreneurship-education platform that teaches students and early founders how to build a startup — idea discovery, customer interviews, MVP building, pitching, and funding applications. One shared platform (Firebase auth/data + FastAPI backend + AI features) ships through two products:
